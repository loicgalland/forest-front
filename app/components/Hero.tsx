...
export const Hero: React.FC = () => {
  return (
    <div className="flex gap-5 my-5 md:my-24 md:flex-row flex-col">
      <div className="flex flex-col justify-between w-full md:w-[65%]">
        <div className="flex flex-col">
          ...
          <p className="w-full mt-5 mb-3 md:mb-0">
        ...
        <Link
          className="w-fit p-1 px-5 rounded-2xl bg-primary text-white"
          href={"/hosting"}
        >
          Nos hébergements
        </Link>
